            ...
            .then(function (data) {
                ...
                for (let auto of data) {
                    ...
                    fila.innerHTML = '<td>' + auto.codigo + '</td>' +
                        ...
                        //Al subir al servidor, deberá utilizarse la siguiente ruta. USUARIO debe ser reemplazado por el nombre de usuario de Pythonanywhere
                        '<td><img src=https://www.pythonanywhere.com/user/eosuna85/files/home/eosuna85/mysite/static/imagenes/' + auto.imagen_url +' alt="Imagen del auto" style="width: 100px;"></td>' + '<td>' + auto.modelo + '</td>' +'<td>' + auto.anio + '</td>' + '<td>' + auto.km + '</td>' + '<td>' + auto.motor + '</td>' + '<td>' + auto.transmision + '</td>';
